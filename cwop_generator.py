...
# RedTeamWX wind barbs and sky cover sprite sheets
...
def main():
    ...
    header_lines = [
        ...
        "Refresh: 5",
        f'IconFile: 1, 25, 25, 12, 12, "{WIND_BARB_ICON_URL}", 10, 3',
